            ...
            <TabsContent value="ai" className="flex-1 overflow-hidden p-2">
              ...
              >
                <TradingAssistantChat 
                  ...
                  placeholder={`Ask about ${selectedPair?.baseAsset || selectedTradingPair}...`}
