  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // RiverBit Brand Colors - Complete Palette
        'river-blue': {
          50: 'var(--river-blue-50)',
          100: 'var(--river-blue-100)',
          200: 'var(--river-blue-200)',
          300: 'var(--river-blue-300)',
          400: 'var(--river-blue-400)',
          500: 'var(--river-blue-500)',
          'light': 'var(--river-blue-light)',
          'main': 'var(--river-blue-main)',
          'dark': 'var(--river-blue-dark)',
          800: 'var(--river-blue-800)',
          900: 'var(--river-blue-900)',
          DEFAULT: 'var(--river-blue-main)',
        },
        'river-accent': {
          'light': 'var(--river-accent-light)',
          'dark': 'var(--river-accent-dark)',
          DEFAULT: 'var(--river-accent)',
        },
      ...
      boxShadow: {
        ...
        'glow-intense': '0 0 32px rgba(59, 130, 246, 0.4), 0 0 64px rgba(6, 182, 212, 0.2)',
        'glow-river': '0 0 24px rgba(6, 182, 212, 0.4), 0 0 48px rgba(34, 211, 238, 0.2)',
        'glow-success': '0 0 20px rgba(16, 185, 129, 0.4)',
        'glow-success-intense': '0 0 32px rgba(16, 185, 129, 0.5), 0 0 64px rgba(34, 197, 94, 0.2)',
        'glow-danger': '0 0 20px rgba(239, 68, 68, 0.4)',
        'glow-danger-intense': '0 0 32px rgba(239, 68, 68, 0.5), 0 0 64px rgba(220, 38, 38, 0.2)',
